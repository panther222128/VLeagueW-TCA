...
let hanSuJin: Member.State = .init(id: UUID(), imageFileName: "GS_12_HanSooJin", name: "한수진", birth: "1999년 7월 2일", tall: 165, weight: 59, position: .libero, number: 12, descriptionTitle: .playStyle, descriptionFileName: "GS_HanSooJin_PlayStyle")
